  ...
  const audiences = [
    {
      ...
      description: 'Da área de tecnologia e inovação que buscam conhecimento e conexões.',
      bgColor: 'bg-green-50',
    ...
    },
    {
      ...
      description: 'Que estão desenvolvendo soluções inovadoras para problemas reais.',
      bgColor: 'bg-amber-50',
    ...
    },
    {
      ...
      description: 'Envolvidos em projetos de transformação digital e novas tecnologias.',
      bgColor: 'bg-blue-50',
    ...
    <section id="publico" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Para quem é a MSD?</h2>
          <div className="w-24 h-1 bg-green-600 mx-auto mb-6"></div>
          <p className="text-lg text-gray-700">
            A Mostra Semiárido Digital é um evento inclusivo, destinado a todos os envolvidos 
            e interessados no ecossistema de inovação e tecnologia.
          </p>
        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <p className="text-gray-700 mb-4">
              Não se preocupe! Qualquer pessoa interessada em inovação, tecnologia e 
              empreendedorismo é bem-vinda para participar e conhecer as iniciativas da região.
            </p>
            <a 
              href="#inscricao" 
