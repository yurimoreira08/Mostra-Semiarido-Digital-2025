                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-amber-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-700">
                        Soluções criativas para desafios regionais
                      </p>
                    </div>
          ...
          <div className="md:w-1/2">
            <div className="max-w-lg">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                A Mostra Semiárido Digital (MSD) é um evento que celebra a
                inovação no coração do sertão. Reunindo estudantes, startups,
                pesquisadores e instituições, a MSD fortalece o ecossistema do
                Vale do Mel ao mostrar que o semiárido também é digital,
                inovador e sustentável.
              </p>

              <p className="text-gray-700 mb-8 leading-relaxed">
                Na edição de 2025, o evento acontece em Picos-PI, no IFPI Campus
                Picos, com uma programação intensa de palestras, pitchs de
                startups, exposição de projetos acadêmicos e muito networking.
              </p>
